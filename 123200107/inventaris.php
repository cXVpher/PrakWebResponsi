...
<div class="body">
    ...
    <table class="table" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td>Rp. <?php $total=$inv["harga"]*$inv["jumlah"]; $totalFormat = number_format($total,2,",","."); echo $totalFormat; ?></td>
	  	    	<td>
		  ...
		  <?php $i++; $totalinventaris=$totalinventaris+$total;?>
    	<?php endforeach; ?>
    </table>
  <p align="center">Total Inventaris = Rp.<?php $totalinventarisformat=number_format($totalinventaris,2,",","."); echo $totalinventarisformat;?></p>
  </div>
